...
interface ResourceFilterBarProps {
  ...
  categories?: string[]; // Available categories from resources
}

export function ResourceFilterBar({ filters, onFilterChange, categories = [] }: ResourceFilterBarProps) {
  const t = useTranslations('admin.resources');

  const handleFilterChange = (key: keyof ResourceFilters, value: string | boolean | undefined) => {
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4 mb-4">
      ...
      <div className="flex items-center gap-3">
        <div className="flex-1 relative">
          ...
          <Input
            placeholder={t('filters.searchPlaceholder') || 'Search resources...'}
