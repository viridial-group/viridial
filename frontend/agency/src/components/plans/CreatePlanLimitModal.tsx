...
import { CreatePlanLimitDto, LimitType } from '@/types/plans';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
interface CreatePlanLimitModalProps {
  open: boolean;
...
export function CreatePlanLimitModal({
  open,
  onOpenChange,
  onSave,
}: CreatePlanLimitModalProps) {
    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            <DialogTitle>{t('addLimit') || 'Add Limit'}</DialogTitle>
            <DialogDescription>
              {t('addLimitDescription') || 'Create a new limit for this plan'}
            </DialogDescription>
          </DialogHeader>
      ...
      <ConfirmationDialog
        ...
        description={t('confirmAddLimit') || 'Are you sure you want to add this limit?'}
