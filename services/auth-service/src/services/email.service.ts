...
export class EmailService {
  ...
  async sendVerificationEmail(email: string, verificationToken: string): Promise<void> {
    const frontendUrl = process.env.FRONTEND_URL || 'https://viridial.com';
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <body>
          <div class="email-wrapper">
            ...
            <div class="email-content">
              <h1 class="title">
                Vérifiez votre <span class="title-highlight">adresse email</span>
              </h1>

              <p class="greeting">Bonjour,</p>

              <p class="message">
                Merci de vous être inscrit sur <span class="message-highlight">Viridial</span> !
              </p>
              ...
              <div class="link-fallback">
                <p class="link-fallback-text">Ou copiez ce lien dans votre navigateur :</p>
                <p class="link-fallback-url">${verifyUrl}</p>
              </div>

              <!-- Expiry Notice -->
              <div class="expiry-notice">
                <p class="expiry-notice-text">
                  <strong>⏰ Important :</strong> Ce lien expirera dans <strong>24 heures</strong> pour votre sécurité.
                </p>
              </div>
              ...
              <div class="security-notice">
                <p class="security-notice-text">
                  <strong>🔒 Sécurité :</strong> Si vous n'avez pas créé de compte Viridial, vous pouvez ignorer cet email en toute sécurité.
                </p>
              </div>

              <!-- Encouragement -->
              <div class="encouragement">
                "Bienvenue dans la communauté Viridial !"
              </div>
            </div>
      ...
      text: `
        ...
        Si vous n'avez pas créé de compte Viridial, vous pouvez ignorer cet email en toute sécurité.
    ...
    try {
      ...
      throw new Error(`Impossible d'envoyer l'email de vérification: ${error.message || error}`);
    }
  }
